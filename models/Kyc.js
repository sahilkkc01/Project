...
const KYC = sequelize.define('KYC', {
  ...
  wife_name: { type: DataTypes.STRING },
  wife_age: { type: DataTypes.INTEGER },
  husband_name: { type: DataTypes.STRING },
  husband_age: { type: DataTypes.INTEGER },
...
//reports
const kycReports = sequelize.define('kycReports', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
const CrmFu_record = sequelize.define('CrmFu_record', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
const CrmApt_record = sequelize.define('CrmApt_record', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
const CrmVis_record = sequelize.define('CrmVis_record', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
const CrmConv_record = sequelize.define('CrmConv_record', {
  id: {
    type: DataTypes.INTEGER,
    primaryKey: true,
    autoIncrement: true
...
module.exports = {KYC,Admin,CrmFu_record,CrmApt_record,CrmVis_record,CrmConv_record,kycReports}
